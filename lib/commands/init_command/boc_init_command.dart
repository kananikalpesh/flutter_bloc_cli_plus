...
import 'package:flutter_bloc_cli_plus/generators/init_generator.dart';
import 'package:flutter_bloc_cli_plus/utils/file_path_utils.dart';
import 'package:flutter_bloc_cli_plus/utils/string_extensions.dart';
...
class BlocInitCommand extends Command with Generator {
  ...
  Future<void> execute() async {
    ...
    if (filePath.contains("flutter_bloc_cli_plus")) {
      String directoryPath = filePath.substring(0, filePath.indexOf("${Platform.pathSeparator}flutter_bloc_cli_plus${Platform.pathSeparator}"));
      String emptyImageFilePath = "$directoryPath${Platform.pathSeparator}flutter_bloc_cli_plus${Platform.pathSeparator}assets${Platform.pathSeparator}images${Platform.pathSeparator}empty.png";
